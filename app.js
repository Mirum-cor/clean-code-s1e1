...
var createNewTaskElement = function (taskString) {
  ...
  var editInput = document.createElement("input"); // text (text)
...
var addTask = function () {
  ...
  // Create a new task-item with the text from the .task-item__task_create-new
...
var deleteTask = function () {
  ...
  // Remove the parent task-item from the section
...
// cycle over incompleteTaskHolder section task items
// for each task-item
for (var i = 0; i < incompleteTaskHolder.children.length; i++) {
  // bind events to task items chldren (tasksCompleted)
  bindTaskEvents(incompleteTaskHolder.children[i], taskCompleted);
}

// cycle over completedTasksHolder section task items
for (var i = 0; i < completedTasksHolder.children.length; i++) {
  // bind events to task items chldren (tasksIncompleted)
